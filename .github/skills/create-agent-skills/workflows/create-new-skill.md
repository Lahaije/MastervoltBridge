...
```powershell
New-Item -ItemType Directory -Path d:\git\MastervoltBridge\skills\{skill-name} -Force
# If complex:
New-Item -ItemType Directory -Path d:\git\MastervoltBridge\skills\{skill-name}\workflows -Force
New-Item -ItemType Directory -Path d:\git\MastervoltBridge\skills\{skill-name}\references -Force
# If needed:
New-Item -ItemType Directory -Path d:\git\MastervoltBridge\skills\{skill-name}\templates -Force  # for output structures
New-Item -ItemType Directory -Path d:\git\MastervoltBridge\skills\{skill-name}\scripts -Force    # for reusable code
```
