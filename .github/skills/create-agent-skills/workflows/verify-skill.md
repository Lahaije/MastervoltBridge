...
Get-ChildItem d:\git\MastervoltBridge\skills\{skill-name}\workflows\ -Filter "*.md" -ErrorAction SilentlyContinue | ForEach-Object { Get-Content $_.FullName }
Get-ChildItem d:\git\MastervoltBridge\skills\{skill-name}\references\ -Filter "*.md" -ErrorAction SilentlyContinue | ForEach-Object { Get-Content $_.FullName }
```
