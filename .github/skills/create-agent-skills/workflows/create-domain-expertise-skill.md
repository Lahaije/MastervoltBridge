...
Explain:
```
Domain expertise skills go in: d:\git\MastervoltBridge\skills\{domain-name}\
...
Location: d:\git\MastervoltBridge\skills\{suggested-name}\
```
...
```powershell
# Create structure
New-Item -ItemType Directory -Path d:\git\MastervoltBridge\skills\{domain-name} -Force
New-Item -ItemType Directory -Path d:\git\MastervoltBridge\skills\{domain-name}\workflows -Force
New-Item -ItemType Directory -Path d:\git\MastervoltBridge\skills\{domain-name}\references -Force
...
# Verify structure
Get-ChildItem -Recurse d:\git\MastervoltBridge\skills\{domain-name}\
```

## Step 11: Document in AGENTS.md

Update the project's main documentation to reference this new domain skill:

Add appropriate reference to the skills directory structure.
...
- [ ] Platform-specific considerations included
- [ ] Located in d:\git\MastervoltBridge\skills\{domain-name}\
