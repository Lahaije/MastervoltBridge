...
<principle id="3">
<title>Router Pattern for Complex Skills</title>
<description>
...
<principle id="4">
<title>Pure XML Structure</title>
<description>
...
<quick_reference>
<title>Skill Structure Quick Reference</title>

<simple_skill_template>
<name>Simple skill (single file)</name>
```yaml
---
name: skill-name
...
<name>Complex skill (router pattern)</name>
```
SKILL.md:
...
<description>All in `workflows/`:</description>
